    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div  id="tab2" style="display: block;">
          <form  name="form" id="form" action="adminusers!adduser" method="post">
            <fieldset>
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->             
            <p>
              <label>会员帐号：</label>
              <input class="text-input small-input" type="text" id="small-input" name="userBean.name" maxlength="20"/>
            </p>
            <p>
              <label>会员邮箱：</label>
              <input class="text-input small-input" type="text" id="small-input" name="userBean.email" maxlength="20"/>
            </p>
            <p>
            	<label>用户积分：</label>
			 <input class="text-input small-input" type="text" id="small-input" name="userBean.integral" />             
            </p>  
            <p>
            	<label>用户类型：</label>
            ...
            <p>
              ...
              <select name="userBean.userStatus" class="small-input">
                ...
                <option value="1">未激活（限制登录）</option>
                <option value="2">异常（限制登录）</option>
              </select>               
            </p>                                                                                                             
            </fieldset>        
            <div class="clear"></div>
