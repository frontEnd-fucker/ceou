	...
	<div id="sidebar" class="fr">
		...
		<div class="floor_4">
			...
			<div class="pd">
				...
				<p class="green-txt">2) 中国企业在线大学产品品牌视频播放展示（14:15-14:20）</p>
				<p class="green-txt">3)	揭幕仪式（14：20-14：40）</p>
				<p>现场招商【3月29日14：50-17：00】</p>
				<p class="green-txt">1)	张文老师发言（14:40-15:00）。宣布揭幕仪式结束拍卖会开始分析中国企业培训产业走势及中国企业在线大学产品优势。</p>
				<p class="green-txt">2)	第一轮中国企业在线大学各地区经营优先权拍卖。（15：00-15：15）</p>
				<p class="green-txt">3)	汪建宏老师分析中国企业在线大学产品特色。（15：15-15：25）</p>
				<p class="green-txt">4)	第二轮中国企业在线大学各地区经营优先权拍卖。（15：25-15：40）</p>
				<p class="green-txt">5)	嘉宾代表讲话（15：40-15：50）。（备选嘉宾：深圳华为顾问田涛、IDG资本李丰、原蒙牛集团孙先红）</p>	
				<p class="green-txt">6)	第三轮中国企业在线大学各地区经营优先权拍卖。（15：50-16：20）</p>		
				<p class="green-txt">7)	现场咨询、现场代理及业务办理（16：20-17：00）</p>																	
			</div>
		</div>
	</div>
	<!-- end sidebar -->
