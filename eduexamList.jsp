            ...
            <div class="cate-box">
                ...
                <div class="cate-content">
                	<dl class="cf">
                    	<dt>按能力分类:</dt>
                        <dd>
                        	<a <s:if test="couIndustry==-1">class="cur"</s:if> href="edu!showCoubyindustry?couIndustry=-1">不限</a>
                        	<a <s:if test="couIndustry==1">class="cur"</s:if> href="edu!showCoubyindustry?couIndustry=1">成考</a>
                       		<a <s:if test="couIndustry==2">class="cur"</s:if> href="edu!showCoubyindustry?couIndustry=2">自考</a>
                        </dd>
                    </dl>
                </div>
            </div><!-- end cate-box -->
            ...
            <div class="tile-box">
                ...
                <div class="tile-content cf">
                    ...
                    <div class="page-nav cf">
                    	<div class="page-num">
		                    <a class="page-home" href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=1">首页</a>
		                    <s:if test="page==1">
		                		<a href="#">上一页</a>
		                	</s:if>
		                	<s:else>
		                		<a href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=<s:property value="page-1"/>" >上一页</a>
		                	</s:else>
		                    ...
		                    <s:if test="%{(page<=3)}">
		                     	<s:if test="%{(totalPage<=5)}">
		                         	<s:iterator begin="1" end="totalPage" var="p">
										<s:if test="#p==page">
		                    				<a href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=<s:property />" class="page-home"><s:property/></a>
		                    			</s:if>
		                    			<s:else>
		                    				<a href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=<s:property />"><s:property/></a>
		                    			</s:else>
		                    		</s:iterator>		                     
		                     	</s:if>
			                 	<s:else>
		                   ...
		                   <!-- test2 begin -->  
		                    ...
		                    <s:else>
		                    	<a href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=<s:property value="page+1"/>">下一页</a>
		                    </s:else>
		                    <a href="edu!showCoubyindustry?couIndustry=<s:property value="couIndustry"/>&page=<s:property value="totalPage"/>">末页</a>
                        </div>
                        <div class="page-skip">
                        	<form action="edu!showCoubyindustry">
