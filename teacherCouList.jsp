                ...
                <div class="cate-content">
                	<dl class="cf">
                        ...
                        <dd>
                            ...
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=4&couSkill=<s:property value="couSkill"/>&couIndustry=<s:property value="couIndustry"/>&page=1">总经理</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=5&couSkill=<s:property value="couSkill"/>&couIndustry=<s:property value="couIndustry"/>&page=1">总监</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=6&couSkill=<s:property value="couSkill"/>&couIndustry=<s:property value="couIndustry"/>&page=1">经理</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=7&couSkill=<s:property value="couSkill"/>&couIndustry=<s:property value="couIndustry"/>&page=1">主管</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=8&couSkill=<s:property value="couSkill"/>&couIndustry=<s:property value="couIndustry"/>&page=1">职员</a>
                        </dd>
                    </dl>
                	<dl class="cf">
                    	<dt>按能力分类:</dt>
                        <dd>
                            ...
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=4&couIndustry=<s:property value="couIndustry"/>&page=1">财务管理</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=5&couIndustry=<s:property value="couIndustry"/>&page=1">店面管理</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=6&couIndustry=<s:property value="couIndustry"/>&page=1">人力资源</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=7&couIndustry=<s:property value="couIndustry"/>&page=1">案例分析</a>
                        </dd>
                    </dl>
                	<dl class="cf">
                    	<dt>按行业分类:</dt>
                        <dd>
                            ...
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=<s:property value="couSkill"/>&couIndustry=4&page=1">美容商学院</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=<s:property value="couSkill"/>&couIndustry=5&page=1">物流商学院</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=<s:property value="couSkill"/>&couIndustry=6&page=1">物业商学院</a>
                            <a href="teacher!showCouByTeacher?thid=<s:property value="thid"/>&couPosition=<s:property value="couPosition"/>&couSkill=<s:property value="couSkill"/>&couIndustry=7&page=1">政务商学院</a>
                        </dd>
                    </dl>                                        
                </div>
            </div><!-- end cate-box -->   
                ...
                <div class="tile-content cf">
                    <s:iterator value="allCouByTeacher">
	                	<dl class="course-intro cf">
	                    	<dt>
	                    		<a href="teacher!showCouByThAndCou?thid=<s:property value="teacherid"/>&couid=<s:property value="couid"/>"><img src="img/kecheng-list.jpg" /></a>
	                    	</dt>
	                        <dd>
	                        	<h3>
	                        	<a href="teacher!showCouByThAndCou?thid=<s:property value="teacherid"/>&couid=<s:property value="couid"/>"><s:property value="couname"/></a>
	                        	</h3>
	                            <p class="course-meta">
	                            	<span>讲师：
	                        ...
	                        <a class="read-more" href="teacher!showCouByThAndCou?thid=<s:property value="teacherid"/>&couid=<s:property value="couid"/>"></a>
	                    </dl>
                    </s:iterator>
