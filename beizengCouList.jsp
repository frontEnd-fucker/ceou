            ...
            <div class="cate-box">
                ...
                <div class="cate-content">
                	<dl class="cf">
                    	<dt>
                            <dd>
                                <a <s:if test="couPosition==1">class="cur"</s:if> href="business!showBeizengCou?catId=3&couPosition=1">绩效管理真谛</a>
                                <a <s:if test="couPosition==2">class="cur"</s:if> href="business!showBeizengCou?catId=3&couPosition=2">职业经理人素质</a>
                                <a <s:if test="couPosition==3">class="cur"</s:if> href="business!showBeizengCou?catId=3&couPosition=3">绩效文化的建立</a>
                            </dd>
                        </dt>
                    </dl>                                      
                </div>
