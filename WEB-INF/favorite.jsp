...
<div id="main" class="wrapper">
    ...
    <div class="fr passport-r">
        ...
        <div class="plain-box my-course cf">
        	<h2 class="rect-title"><span>我的收藏</span></h2>
			<div class="courses">
            	<s:iterator value="UcrBean">
                   ...
                   <div class="page-nav cf">
                    	<div class="page-num">
		                    <a class="page-home" href="personal!showUCRecord?page=1&status=1">首页</a>
		                    <s:if test="page==1">
		                		<a href="#">上一页</a>
		                	</s:if>
		                	<s:else>
		                		<a href="personal!showUCRecord?page=<s:property value="page-1"/>&status=1" >上一页</a>
		                	</s:else>
		                    ...
		                    <s:if test="%{(page<=3)}">
		                     	<s:if test="%{(totalPage<=5)}">
		                         	<s:iterator begin="1" end="totalPage" var="p">
										<s:if test="#p==page">
		                    				<a href="personal!showUCRecord?page=<s:property />&status=1" class="page-home"><s:property/></a>
		                    			</s:if>
		                    			<s:else>
		                    				<a href="personal!showUCRecord?page=<s:property />&status=1"><s:property/></a>
		                    			</s:else>
		                    		</s:iterator>		                     
		                     	</s:if>
			                 	<s:else>
		                   ...
		                   <!-- test2 begin -->  
		                    ...
		                    <s:else>
		                    	<a href="personal!showUCRecord?page=<s:property value="page+1"/>&status=1">下一页</a>
		                    </s:else>
		                    <a href="personal!showUCRecord?page=<s:property value="totalPage"/>&status=1">末页</a>
                        </div>
                        <div class="page-skip">
